...
import com.example.navigationapp.databinding.FragmentThirdBinding
...
class FragmentThird : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnClick.setOnClickListener{
            if (isLoggedInUser){
                Navigation.findNavController(it).navigate(R.id.action_fragmentThird_to_fragmentFourth)
            } else{
                Navigation.findNavController(it).navigate(R.id.action_fragmentThird_to_fragmentFifth)
            }
        }
        return binding.root
    }
